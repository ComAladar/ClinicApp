...
#define MyAppName "ClinicApp"
#define MyAppVersion "1.0"
#define MyAppPublisher "Gromov Nikita"
#define MyAppURL "https://github.com/ComAladar/ClinicApp"
#define MyAppExeName "ClinicAppUI.exe"
#define MyAppAssocName MyAppName + ""
#define MyAppAssocExt ".myp"
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt
#define MyAppIcoName= "ClinicAppMainIcon.ico"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{915B624B-D6E6-479E-B3BE-4A8049A26B1A}
AppName={#MyAppName}
...
OutputBaseFilename=SetupClinicApp
Compression=lzma
...
Name: "{userdesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; \
    IconFilename: "{app}\Icon\{#MyAppIcoName}"; Tasks: desktopicon
